...
export default class extends RenderApp {
    static title_ = "Triangle shaders with vertex buffers normalized values."
    ...
    constructor(
        ...
        this.pipeline_ = this.device.createRenderPipeline({
            ...
            vertex: {
                ...
                buffers: [{
                    ...
                    arrayStride: kVertexColorUnitSize,
                    attributes: [{
                        shaderLocation: 4,
                        offset: 0,
                        format: "unorm8x4",
        ...
        const { vertexData: vertexPositions, verticeCount } = createCircleVertices({
    ...
    public render_() {
        ...
        pass.setVertexBuffer(3, this.vertexColorBuffer_)
